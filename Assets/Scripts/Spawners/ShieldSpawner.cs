...
public class ShieldSpawner : MonoBehaviour
{
    ...
    private void SpawnShield()
    {
        ...
        // Certifique-se de adicionar o componente ShieldController ao shieldPrefab para lidar com a l�gica de coleta e ativa��o do escudo

        // Se desejar, voc� pode definir outras propriedades ou comportamentos para o shield aqui
